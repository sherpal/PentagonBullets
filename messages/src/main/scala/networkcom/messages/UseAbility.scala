...
final case class UseTripleBullet(
    gameName: String,
    time: Long,
    useId: Long,
    casterId: Long,
...
final case class UseTeleportation(
    gameName: String,
    time: Long,
    useId: Long,
    casterId: Long,
...
final case class UseCreateHealingZone(gameName: String, time: Long, useId: Long, casterId: Long, targetPos: Point)
    extends UseAbility
final case class UseCreateBulletAmplifier(
    gameName: String,
    time: Long,
    useId: Long,
    casterId: Long,
...
final case class UseLaunchSmashBullet(
    gameName: String,
    time: Long,
    useId: Long,
    casterId: Long,
...
final case class UseCraftGunTurret(gameName: String, time: Long, useId: Long, casterId: Long, teamId: Int, pos: Point)
    extends UseAbility
final case class UseCreateBarrier(
    gameName: String,
    time: Long,
    useId: Long,
    casterId: Long,
