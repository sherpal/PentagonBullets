...
//    GameEnded
  ...
  def withBulletAmplifier(id: Long, time: Long, bulletAmplifier: BulletAmplifier): GameState = new GameState(
    ...
    healingZones,
    abilityGivers,
    bulletAmplifiers + (id -> bulletAmplifier),
    barriers,
    smashBullets,
    mists,
    actionChangers,
  ...
  def withActionChanger(id: Long, time: Long, actionChanger: ActionChanger): GameState = new GameState(
    ...
    smashBullets,
    mists,
    actionChangers + (id -> actionChanger),
    laserLaunchers,
    flags
  )
  ...
  def withLaserLauncher(id: Long, time: Long, laserLauncher: LaserLauncher): GameState = new GameState(
    ...
    mists,
    actionChangers,
    laserLaunchers + (id -> laserLauncher),
    flags
  )
  ...
  def applyActionChangers(actions: List[GameAction]): List[GameAction] = {
    ...
    actions.flatMap(
      action =>
        changers
          .foldLeft(List(action))((as: List[GameAction], changer: ActionChanger) => as.flatMap(changer.changeAction))
    )
  }
