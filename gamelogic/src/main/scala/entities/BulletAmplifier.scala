 ...
 * list.
 */
class BulletAmplifier(val id: Long, val creationTime: Long, val ownerId: Long, val xPos: Double, val yPos: Double,
                      val shape: Polygon, val rotation: Double, transformedBullets: List[Long]) extends Body {
