...
class GunTurret(val creationTime: Long, val id: Long, val ownerId: Long, val teamId: Int,
                val xPos: Double, val yPos: Double,
                val lastShot: Long, val radius: Double, val rotation: Double,
                val lifeTotal: Double) extends Body with Living {
