...
object ControlSettings {
  ...
  private def selectors: List[ControlSelector] = List(
    ...
    Selectors.up,
    Selectors.down,
    Selectors.bulletShoot,
    Selectors.selectedAbility,
    Selectors.shieldAbility
  )
  ...
  restoreDefaults.onclick = (_: dom.Event) => {
    ...
    Selectors.right.changeBinding(
      default.right._1,
      default.right._2,
      default.keyCodeToKey.getOrElse(default.right._2, "")
    )
    ...
    Selectors.bulletShoot.changeBinding(
      default.bulletShoot._1,
      default.bulletShoot._2,
      default.keyCodeToKey.getOrElse(default.bulletShoot._2, "")
    )
    Selectors.selectedAbility.changeBinding(
      default.selectedAbility._1,
      default.selectedAbility._2,
      default.keyCodeToKey.getOrElse(default.selectedAbility._2, "")
    )
    Selectors.shieldAbility.changeBinding(
      default.abilities.head._1,
      default.abilities.head._2,
  ...
  private def bindings: ControlBindings =
    selectors.foldLeft(KeyBindingsLoader.bindings)({
